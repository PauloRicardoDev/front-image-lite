...
const Header: React.FC = () => {
    return (
        <header className="bg-gradient-to-r from-indigo-800 to-indigo-250 bg-opacity-50
         text-white p-5 flex justify-between items-center">
            <h1 className="text-1xl">Image Lite App</h1>
            <h1 className="ml-5 text-xs text-gray-600">
...
const Loading: React.FC = () => {
    return (
        <div role="status" className="flex flex-row gap-3 justify-center items-center">
