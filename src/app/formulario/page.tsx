            ...
            <section className="flex flex-col justify-center container mx-auto p-10">
                ...
                <Link href="galeria">
                    <section className="mb-10 w-48 flex flex-row justify-start gap-1 items-center
                     bg-gradient-to-r from-neutral-700 to-neutral-700 transition duration-300 ease-in-out p-3
                     rounded-lg hover:from-orange-500 hover:to-orange-500 hover:bg-opacity-70
                    ">
                        ...
                        <div
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-4 flex text-sm leading-6 text-gray-600 items-center mb-5">
                                    <label
                                        className="relative cursor-pointer rounded-md bg-neutral-600 p-2 font-semibold text-neutral-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                        <RenderIf condition={!imagePreview}>
